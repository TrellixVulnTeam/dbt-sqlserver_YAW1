...
def _cleanup_function(testfolder, mdb_name):
    try:
        ...
        pass  # mdb 1_database not present
    try:
...
def makemdb(testfolder, mdb_name):
    ...
    if os.path.isfile(_accessdatasource):
        print("using JET 1_database=", _accessdatasource)
    else:
        try:
        ...
        # Create a brand-new 1_database - what is the story with these?
        dbe = None
...
if __name__ == "__main__":
    print("Setting up a Jet 1_database for server to use for remote testing...")
    temp = maketemp()
