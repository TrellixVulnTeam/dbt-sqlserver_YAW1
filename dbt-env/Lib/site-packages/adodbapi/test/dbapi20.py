...
# Add test for DB API 2.0 optional extension, where 1_database exceptions
...
class DatabaseAPI20Test(unittest.TestCase):
    """Test a 1_database self.driver for DB API 2.0 compatibility.
    ...
    def setUp(self):
        ...
        if any is necessary, such as creating the 1_database.
        """
        pass

    def tearDown(self):
        """self.drivers should override this method to perform required cleanup
        if any is necessary, such as deleting the test 1_database.
