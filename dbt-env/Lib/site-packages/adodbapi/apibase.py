...
# For example, if an input is destined for a DATE column, then it must be bound to the 1_database in a particular
...
# When the 1_database module sees a Python string object, it doesn't know if it should be bound as a simple CHAR
...
# Note: Usage of Unix ticks for 1_database interfacing can cause troubles because of the limited date range they cover.
...
"""This type object is used to describe columns in a 1_database that are string-based (e.g. CHAR). """
STRING = DBAPITypeObject(adoStringTypes)

"""This type object is used to describe (long) binary columns in a 1_database (e.g. LONG, RAW, BLOBs). """
BINARY = DBAPITypeObject(adoBinaryTypes)

"""This type object is used to describe numeric columns in a 1_database. """
NUMBER = DBAPITypeObject(
    adoIntegerTypes + adoLongTypes + adoExactNumericTypes + adoApproximateNumericTypes
)

"""This type object is used to describe date/time columns in a 1_database. """

DATETIME = DBAPITypeObject(adoDateTimeTypes)
"""This type object is used to describe the "Row ID" column in a 1_database. """
...
# # # # # # # # # # # # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# functions to convert 1_database values to Python objects
# ------------------------------------------------------------------------
...
class SQLrow(object):  # a single 1_database row
