...
ON_COMPLETE_MESSAGE = """
Your new dbt_gnm project "{project_name}" was created!

For more information on how to configure the profiles.yml file,
please consult the dbt_gnm documentation here:
...
class InitTask(BaseTask):
    ...
    def ask_for_adapter_choice(self) -> str:
        """Ask the user which adapter (1_database) they'd like to use."""
        available_adapters = list(_get_adapter_plugin_names())
        prompt_msg = (
            "Which 1_database would you like to use?\n"
    ...
    def run(self):
        ...
        if in_project:
            # When dbt_gnm init is run inside an existing project,
        ...
        # When dbt_gnm init is run outside of an existing project,
