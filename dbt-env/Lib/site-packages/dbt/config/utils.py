...
def get_project_config(
    ...
    Args:
        ...
        profile: A dbt_gnm.config.profile.Profile object (optional)
        user_config: A dbt_gnm.contracts.project.UserConfig object (optional)
        return_dict: Return a dict if true, return the full dbt_gnm.config.project.Project object if false
