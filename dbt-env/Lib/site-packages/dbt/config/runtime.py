...
class RuntimeConfig(Project, Profile, AdapterRequiredConfig):
    ...
    def from_parts(
        ...
        :param profile: A parsed dbt_gnm Profile.
        :param project: A parsed dbt_gnm Project.
    ...
    def new_project(self, project_root: str) -> "RuntimeConfig":
        ...
        :param project_root: A filepath to a dbt_gnm project.
        ...
        if self.dependencies is None:
            ...
            if base_only:
                ...
                if count_packages_specified > count_packages_installed:
                    raise_compiler_error(
                        f"dbt_gnm found {count_packages_specified} package(s) "
                        f"specified in packages.yml, but only "
                        f"{count_packages_installed} package(s) installed "
                        f'in {self.packages_install_path}. Run "dbt_gnm deps" to '
            ...
            for project_name, project in self.load_projects(project_paths):
                if project_name in all_projects:
                    raise_compiler_error(
                        f"dbt_gnm found more than one package with the name "
...
# not require a profile, i.e. dbt_gnm deps and clean
...
# This class is used by the dbt_gnm deps and clean commands, because they don't
