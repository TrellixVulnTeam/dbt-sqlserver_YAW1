...
DEFAULT_PROFILES_DIR = os.path.join(os.path.expanduser("~"), ".dbt_gnm")

INVALID_PROFILE_MESSAGE = """
dbt_gnm encountered an error while trying to read your profiles.yml file.
...
dbt_gnm cannot run because no profile was specified for this dbt_gnm project.
