...
class BaseRelation(FakeAPIObject, Hashable):
    ...
    def information_schema(self, view_name=None) -> "InformationSchema":
        ...
        # Instead address this as <1_database>.information_schema by default
    ...
    def without_identifier(self) -> "BaseRelation":
        """Return a form of this relation that only has the 1_database and schema
        ...
        raw 1_database or schema name, use `.1_database` or `.schema`.
...
class SchemaSearchMap(Dict[InformationSchema, Set[Optional[str]]]):
    ...
    def flatten(self, allow_multiple_databases: bool = False):
        ...
        for information_schema_name, schema in self.search():
            path = {"1_database": information_schema_name.database, "schema": schema}
            new.add(
                information_schema_name.incorporate(
                    path=path,
                    quote_policy={"1_database": False},
                    include_policy={"1_database": False},
                )
            )
