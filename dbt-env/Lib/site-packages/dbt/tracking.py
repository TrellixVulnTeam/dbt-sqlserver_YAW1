...
INVOCATION_SPEC = "iglu:com.dbt_gnm/invocation/jsonschema/1-0-2"
PLATFORM_SPEC = "iglu:com.dbt_gnm/platform/jsonschema/1-0-0"
RUN_MODEL_SPEC = "iglu:com.dbt_gnm/run_model/jsonschema/1-0-1"
INVOCATION_ENV_SPEC = "iglu:com.dbt_gnm/invocation_env/jsonschema/1-0-0"
PACKAGE_INSTALL_SPEC = "iglu:com.dbt_gnm/package_install/jsonschema/1-0-0"
RPC_REQUEST_SPEC = "iglu:com.dbt_gnm/rpc_request/jsonschema/1-0-1"
DEPRECATION_WARN_SPEC = "iglu:com.dbt_gnm/deprecation_warn/jsonschema/1-0-0"
LOAD_ALL_TIMING_SPEC = "iglu:com.dbt_gnm/load_all_timing/jsonschema/1-0-3"
RESOURCE_COUNTS = "iglu:com.dbt_gnm/resource_counts/jsonschema/1-0-0"
EXPERIMENTAL_PARSER = "iglu:com.dbt_gnm/experimental_parser/jsonschema/1-0-0"
PARTIAL_PARSER = "iglu:com.dbt_gnm/partial_parser/jsonschema/1-0-1"
RUNNABLE_TIMING = "iglu:com.dbt_gnm/runnable/jsonschema/1-0-0"
...
class User:
    ...
    def set_cookie(self):
        # If the user points dbt_gnm to a profile directory which exists AND
        ...
        # will change in every dbt_gnm invocation until the user points to a
...
def track_invocation_start(config=None, args=None):
    ...
    track(active_user, category="dbt_gnm", action="invocation", label="start", context=context)
...
def track_model_run(options):
    ...
    track(
        active_user, category="dbt_gnm", action="run_model", label=get_invocation_id(), context=context
    )
...
def track_invocation_end(config=None, args=None, result_type=None):
    ...
    track(active_user, category="dbt_gnm", action="invocation", label="end", context=context)
...
def track_invalid_invocation(config=None, args=None, result_type=None):
    ...
    track(active_user, category="dbt_gnm", action="invocation", label="invalid", context=context)
