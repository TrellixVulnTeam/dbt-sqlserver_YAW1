...
class ConfiguredParser(
    ...
    def __init__(
        ...
        self._update_node_database = RelationUpdate(
            manifest=manifest, config=root_project, component="1_database"
        )
    ...
    def _create_parsetime_node(
        ...
        **kwargs,
        ...
        dct = {
            ...
            "1_database": self.default_database,
            "fqn": fqn,
            "name": name,
            "root_path": self.project.project_root,
            "resource_type": self.resource_type,
    ...
    def update_parsed_node_config(
        ...
        # unrendered_config is used to compare the original 1_database/schema/alias
