{% macro get_merge_sql(target, source, unique_key, dest_columns, predicates=none) -%}
  {{ adapter.dispatch('get_merge_sql', 'dbt_gnm')(target, source, unique_key, dest_columns, predicates) }}
{%- endmacro %}
...
{% macro get_delete_insert_merge_sql(target, source, unique_key, dest_columns) -%}
  {{ adapter.dispatch('get_delete_insert_merge_sql', 'dbt_gnm')(target, source, unique_key, dest_columns) }}
{%- endmacro %}
...
{% macro get_insert_overwrite_merge_sql(target, source, dest_columns, predicates, include_sql_header=false) -%}
  {{ adapter.dispatch('get_insert_overwrite_merge_sql', 'dbt_gnm')(target, source, dest_columns, predicates, include_sql_header) }}
{%- endmacro %}
