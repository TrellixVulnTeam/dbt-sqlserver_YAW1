...
{% macro snapshot_hash_arguments(args) -%}
  {{ adapter.dispatch('snapshot_hash_arguments', 'dbt_gnm')(args) }}
{%- endmacro %}
...
{% macro snapshot_get_time() -%}
  {{ adapter.dispatch('snapshot_get_time', 'dbt_gnm')() }}
{%- endmacro %}
...
{% macro snapshot_timestamp_strategy(node, snapshotted_rel, current_rel, config, target_exists) %}
    ...
    {#/*
        ...
        should use a dbt_gnm-created column for the comparison in the snapshot
...
{% macro snapshot_string_as_time(timestamp) -%}
    {{ adapter.dispatch('snapshot_string_as_time', 'dbt_gnm')(timestamp) }}
{%- endmacro %}
