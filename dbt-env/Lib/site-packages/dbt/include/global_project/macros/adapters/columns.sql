{% macro get_columns_in_relation(relation) -%}
  {{ return(adapter.dispatch('get_columns_in_relation', 'dbt_gnm')(relation)) }}
{% endmacro %}
...
{% macro get_columns_in_query(select_sql) -%}
  {{ return(adapter.dispatch('get_columns_in_query', 'dbt_gnm')(select_sql)) }}
{% endmacro %}
...
{% macro alter_column_type(relation, column_name, new_column_type) -%}
  {{ return(adapter.dispatch('alter_column_type', 'dbt_gnm')(relation, column_name, new_column_type)) }}
{% endmacro %}
...
{% macro alter_relation_add_remove_columns(relation, add_columns = none, remove_columns = none) -%}
  {{ return(adapter.dispatch('alter_relation_add_remove_columns', 'dbt_gnm')(relation, add_columns, remove_columns)) }}
{% endmacro %}
