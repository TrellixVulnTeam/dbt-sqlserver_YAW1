{% macro alter_column_comment(relation, column_dict) -%}
  {{ return(adapter.dispatch('alter_column_comment', 'dbt_gnm')(relation, column_dict)) }}
{% endmacro %}
...
{% macro alter_relation_comment(relation, relation_comment) -%}
  {{ return(adapter.dispatch('alter_relation_comment', 'dbt_gnm')(relation, relation_comment)) }}
{% endmacro %}
...
{% macro persist_docs(relation, model, for_relation=true, for_columns=true) -%}
  {{ return(adapter.dispatch('persist_docs', 'dbt_gnm')(relation, model, for_relation, for_columns)) }}
{% endmacro %}
