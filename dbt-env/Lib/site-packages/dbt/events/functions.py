...
def setup_event_logger(log_path, level_override=None):
    ...
    log_dest = os.path.join(log_path, "dbt_gnm.log")
...
def fire_event(e: Event) -> None:
    ...
    # backwards compatibility for plugins that require old logger (dbt_gnm-rpc)
...
def set_invocation_id() -> None:
    ...
    # commands in the dbt_gnm servers. It shouldn't be necessary for the CLI.
    global invocation_id
    invocation_id = str(uuid.uuid4())
